...
//    QString  str=QString::asprintf("%d Bytes",dt);
    ui->plainTextEdit->appendPlainText(str+"\n");
}
...
//    ui->editDir->setText(QDir::currentPath());
...
{//QTemporaryDir
    ...
    QTemporaryDir    dir;
//        QTemporaryDir    dir("ZhanDian-XXXXXX");
...
//    QObject::disconnect(&fileWatcher,SIGNAL(directoryChanged(const QString)),
//            this,SLOT(on_directoryChanged(const  QString))); //directoryChanged

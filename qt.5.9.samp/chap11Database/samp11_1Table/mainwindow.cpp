...
//    DB=QSqlDatabase::("QSQLITE"); //添加 SQL LITE数据库到数据库连接，创建缺省数据库连接
}
...
//void MainWindow::on_primeInsert(int row, QSqlRecord &record)
//{
//    record.setValue("empNo",2000+row);
//    record.setValue("Gender","男");
//}
...
//void MainWindow::on_actCloseDB_triggered()
//{
//    DB.close();
//    LabDBOpened->setText("数据库状态：closed");
//}

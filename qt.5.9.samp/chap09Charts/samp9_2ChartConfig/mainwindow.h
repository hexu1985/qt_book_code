...
//    void on_comboPenStyle_currentIndexChanged(int index);

//    void on_spinLineWidth_valueChanged(int arg1);

//    void on_chkLineVisible_clicked(bool checked);
...
//    void on_chkBoxTickVisible_clicked(bool checked);

//    void on_chkBoxMinorTickVisible_clicked(bool checked);

    void on_checkBox_clicked(bool checked);

//    void on_chkGridLineVisible_clicked();
...
//    void on_radioAnimation0_clicked();

//    void on_radioAnimation1_clicked();

//    void on_radioAnimation2_clicked();

//    void on_radioAnimation3_clicked();

...
//static QString SampleTypeString(QAudioFormat::SampleType sampleType)
//{
...
//static QString ByteOrderString(QAudioFormat::Endian endian)
//{
//    QString result("Unknown");
//    switch (endian) {
...
//{
//    int bytes=audioInput->bytesReady();
//    QByteArray   byteArray=ioDevice->read(bytes);

//    QVector<QPointF> points;

//    for(int i=0;i<byteArray.size();i++)
//        points.append(QPointF(i, byteArray[i]));

//    lineSeries->replace(points);
//}

//void MainWindow::on_stateChanged(QAudio::State state)
//{
//    if (state==QAudio::ActiveState)   //有数据可读取
//    {
//        int bytes=audioInput->bytesReady();
//        QByteArray   byteArray=ioDevice->read(bytes);
//        QVector<QPointF> points;
...
//void MainWindow::on_IODevice_readyRead()
//{
////    int bytes=ioDevice->bytesAvailable();
////    QByteArray   byteArray=ioDevice->read(bytes);
////    QVector<QPointF> points;

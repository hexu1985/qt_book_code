...
//    QRectF   rect(-300,-150,600,300); //左上角坐标，宽度，高度
    scene=new QGraphicsScene(rect); //scene逻辑坐标系定义
//    scene=new QGraphicsScene(0,0,800,600); //view逻辑坐标系定义，左上角是(-200,-100)，宽度400，高度200
//    scene=new QGraphicsScene; //view的大小是600*400

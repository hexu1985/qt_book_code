...
MainWidget::createCtrlWidget()
{
    ...
    gradientComboBox->addItem(tr("Linear Gradient"), (int) Qt::LinearGradientPattern);
    gradientComboBox->addItem(tr("Radial Gradient"), (int) Qt::RadialGradientPattern);
    gradientComboBox->addItem(tr("Conical Gradient"), (int) Qt::ConicalGradientPattern);
    connect(gradientComboBox,SIGNAL(activated(int)),this,SLOT(slotSetStyle(int)));
    
    spreadComboBox = new QComboBox;
    spreadComboBox->addItem(tr("PadSpread"), (int) QGradient::PadSpread);
    spreadComboBox->addItem(tr("RepeatSpread"), (int) QGradient::RepeatSpread);
    spreadComboBox->addItem(tr("ReflectSpread"),(int) QGradient::ReflectSpread);
